...
public class CallMediatorBlockingSenderTestCase extends ESBIntegrationTest {
    ...
    public void deployService() throws Exception {
        ...
        for (String configName : configs) {
            loadESBConfigurationFromClasspath(File.separator + "artifacts" + File.separator + "ESB"
                    + File.separator + "mediatorconfig" + File.separator + "call_blocking" + File.separator
                    + configName + ".xml");
            if(configName.equals("HTTPStatusResponseAPI")){
                verifyAPIExistence("HTTPStatusResponseAPI");
            } else
