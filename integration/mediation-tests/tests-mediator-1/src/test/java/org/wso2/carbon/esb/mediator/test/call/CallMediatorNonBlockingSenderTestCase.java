...
public class CallMediatorNonBlockingSenderTestCase extends ESBIntegrationTest {

    @BeforeClass(alwaysRun = true)
    public void deployService() throws Exception {
        super.init();
        String[] configs = {"HTTPStatusResponseAPI_nb", "AcceptedEndpointProxy_nb", "BadRequestEndpointProxy_nb",
                "ConflictEndpointProxy_nb", "ForbiddenEndpointProxy_nb", "NotFoundEndpointProxy_nb",
                "ServerErrorEndpointProxy_nb", "UnauthorizedEndpointProxy_nb"};
        for (String configName : configs) {
            loadESBConfigurationFromClasspath(File.separator + "artifacts" + File.separator + "ESB"
                    + File.separator + "mediatorconfig" + File.separator + "call_non_blocking" + File.separator
                    + configName + ".xml");
            if(configName.equals("HTTPStatusResponseAPI_nb")){
    ...
    public void testAcceptedHttpStatusEndpoint() throws Exception {
        URL endpoint = new URL(getProxyServiceURLHttp("AcceptedEndpointProxy_nb"));
    ...
    public void testBadRequestHttpStatusEndpoint() throws Exception {
        URL endpoint = new URL(getProxyServiceURLHttp("BadRequestEndpointProxy_nb"));
    ...
    public void testUnauthorizedHttpStatusEndpoint() throws Exception {
        URL endpoint = new URL(getProxyServiceURLHttp("UnauthorizedEndpointProxy_nb"));
    ...
    public void testForbiddenHttpStatusEndpoint() throws Exception {
        URL endpoint = new URL(getProxyServiceURLHttp("ForbiddenEndpointProxy_nb"));
    ...
    public void testNotFoundHttpStatusEndpoint() throws Exception {
        URL endpoint = new URL(getProxyServiceURLHttp("NotFoundEndpointProxy_nb"));
    ...
    public void testConflictHttpStatusEndpoint() throws Exception {
        URL endpoint = new URL(getProxyServiceURLHttp("ConflictEndpointProxy_nb"));
    ...
    public void testServerErrorHttpStatusEndpoint() throws Exception {
        URL endpoint = new URL(getProxyServiceURLHttp("ServerErrorEndpointProxy_nb"));
